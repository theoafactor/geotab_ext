...
def paginate_data(data, records_length, page_size):
    page_size = 500
    total_pages = math.ceil(records_length / page_size) 
    for i in range(total_pages):
        start = i * page_size
        end = start + page_size
        yield i + 1, data[start:end]
    ...
    try:
        ...
        for table in active_tables: 
            ...
            if max_records_per_call == 0: 
                ...
                #paginate_data(max_records_per_call, 500)
                pass
